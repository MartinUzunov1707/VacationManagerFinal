...
namespace VacationManagerFinal.Data.Migrations
{
    ...
    [Migration("20240413153303_Initial migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VacationManager.Data.Models.Break", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("VacationManager.Data.Models.Employee", b =>
                {
            ...
            modelBuilder.Entity("VacationManager.Data.Models.Break", b =>
                {
                    b.HasOne("VacationManager.Data.Models.Employee", "Requestee")
                        .WithMany()
            ...
            modelBuilder.Entity("VacationManager.Data.Models.Team", b =>
                {
                    ...
                    b.HasOne("VacationManager.Data.Models.Employee", "TeamLead")
                        .WithMany()
            ...
            modelBuilder.Entity("VacationManager.Data.Models.Employee", b =>
                {
                    b.HasOne("VacationManager.Data.Models.Team", "CurrentTeam")
                        .WithMany("Employees")
